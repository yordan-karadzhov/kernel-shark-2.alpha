...
public:
	...
	/** Set the position of the bottom-left corner of the frame. */
	void setPos(const Point &p) {_box.setPoint(0, p);}

	/** Set the color and the dimensions of the frame. */
...
public:
	...
	/** The Mark will be plotted as a dashed line. */
...
private:
	...
	/* Plot the Mark as a dashed line. */
	bool _dashed;

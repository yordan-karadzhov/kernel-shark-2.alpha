...
/**
 * @brief Set the point of the shape indexed by "i".
 *
...
void TextBox::_draw(const Color &col, float size) const
{
	...
	bShift = (_box.getPointY(0) - _box.getPointY(1) - _font->height) / 2;
...
void Graph::_initBins()
{
	for (int i = 0; i < _size; ++i) {
		_bins[i]._base.setX(i + _bin0Offset());
...
/**
 * @brief Set the width of the space reserved for the label of the graph.
 *
